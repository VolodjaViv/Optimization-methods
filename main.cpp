...
int main() {
    ...
    vector<double> B(rows), C(columns), X(columns);
    vector<int> J_B(rows);
...
3 8 3Х8
-2 -1 1 -7 0 0 0 2
4 2 -1 0 1 5 -1 -5  МАТРИЦА А
1 11 0 1 0 3 1 1
1 1 1 ВЕКТОР Б
6 -9 5 -2 6 0 -1 3 КОЭФИЦИЕНТЫ ФУНКЦИИ
4 0 6 0 4 0 0 0 Х НАЧАЛЬНЫЕ ЗНАЧЕНИЯ
1 2 3 БАЗИСНЫЕ ИНДЕКСЫ
*/